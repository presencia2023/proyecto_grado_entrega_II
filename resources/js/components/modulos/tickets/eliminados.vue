            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Tickets eliminados</h3>
                            <div class="card-tools">
...
export default {
    ...
    methods: {
        ...
        restauraSeleccionados() {
            Swal.fire({
                title: "¿Está seguro(a) de restaurar los tickets seleccionados?",
                ...
                if (result.isConfirmed) {
                    for (let i = 0; i < this.array_seleccion.length; i++) {
                        this.restauraTicket(this.array_seleccion[i]);
                    }
                    ...
                    setTimeout(() => {
                        ...
                        Swal.fire({
                            icon: "success",
                            title: "¡Registro(s) restaurados(s) con éxito!",
        ...
        restauraTicket(id) {
            axios
                .post("/admin/tickets/restaura_ticket/" + id, {
                    _method: "POST",
                })
                .then((res) => {
                    // Swal.fire({
