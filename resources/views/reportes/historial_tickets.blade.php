...
<head>
    ...
    <style type="text/css">
        * {
        ...
        .registro {
            background: rgba(185, 224, 241, 0.692);
        }

        .solucion {
            background: rgba(218, 241, 191, 0.692);
        }
    </style>
</head>
...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">HISTORIAL DE SOLICITUD DE TICKETS </h4>
    ...
    @foreach ($tickets as $ticket)
        <table border="1">
            <tbody>
                ...
                @foreach ($ticket->solucion_tickets as $s)
                    @php
                        $class = 'registro';
                        if ($s->tipo_incidencia == 'SOLUCION') {
                            $class='solucion';
                        }
                    @endphp
                    <tr class="{{ $class }}">
                        <td>
                            <p><u><strong>{{ $s->tipo_incidencia }}</strong></u></p>
